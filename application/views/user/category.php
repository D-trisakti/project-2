        ...
        <div class="section text-center">
            ...
            <div class="row">
                <?php foreach ($product as $product) : ?>
                    ...
                    <img class="card-img" src="<?= base_url('assets/uploads/') . $product['image_product']; ?>" alt="Card image cap"style="width: 22rem;" height="320px">
                        <div class="card-img-overlay" style="width: 22rem;" height="320px">
                        <h4 class=" float-left badge badge-pill badge-info"><?= $product['price_product']; ?>,-IDR</h4>
                        </div>
                    </div>
                        <div class="card-body">
                            <h4 class="card-title"><?= $product['nama_product']; ?></h4>

                            <p class="card-text"><?= $product['deskripsi_product']; ?></p>
